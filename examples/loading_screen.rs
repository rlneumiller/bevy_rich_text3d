...
use bevy::{
    app::{App, Startup, Update}, asset::{AssetId, AssetServer, Assets}, color::Color, core_pipeline::core_2d::Camera2d, ecs::{component::Component, entity::Entity, query::With, system::{Local, Query}}, hierarchy::DespawnRecursiveExt, image::Image, math::{Vec2, Vec3}, pbr::AmbientLight, prelude::{
        Commands, Mesh, OrthographicProjection, Plane3d, Projection, Res, ResMut, Transform,
    }, render::mesh::Mesh2d, sprite::{AlphaMode2d, ColorMaterial, MeshMaterial2d, Sprite}, time::{Time, Virtual}, DefaultPlugins
};
use bevy_rich_text3d::{DrawStyle, Text3d, Text3dPlugin, Text3dStyling, TextAtlas, TextProgressReportCallback, TextRenderer};
...
pub fn main() {
    ...
    App::new()
        ...
        .add_systems(Update, move |mut commands: Commands, timer: Res<Time<Virtual>>, mut local: Local<f32>, mut query: Query<(Entity, &mut Transform), With<Swirl>>| {
        ...
        .add_systems(Startup, move |settings: Res<Text3dPlugin>, text_renderer: Res<TextRenderer>, mut atlases: ResMut<Assets<TextAtlas>>, mut images: ResMut<Assets<Image>>| {
            ...
            )], &mut atlases, &mut images, callback.take().unwrap());
