//! Showcases and stress tests underscores strikethroughs and their various interactions.
...
fn setup(
    ...
    commands.spawn((
        Text3d::parse_raw("{_:Hello Underscore!}").unwrap(),
        Text3dStyling {
            size: 64.,
            stroke: NonZero::new(10),
            color: Srgba::new(0., 1., 1., 1.),
    ...
    commands.spawn((
        Text3d::parse_raw("This {_:underscore} thing sure is neat!").unwrap(),
        Text3dStyling {
            color: Srgba::new(0., 1., 1., 1.),
            ..Default::default()
        },
    ...
    commands.spawn((
        Text3d::parse_raw("We {~:can} do {~:{_:both}}!").unwrap(),
        Text3dStyling {
            size: 64.,
            stroke: NonZero::new(10),
            color: Srgba::new(0., 1., 1., 1.),
        ...
        Mesh2d::default(),
        MeshMaterial2d(mat.clone()),
        Transform::from_translation(Vec3::new(50., -120., 0.)),
    ));


    commands.spawn((
        Text3d::parse_raw("{_:{s-red:r}{s-orange:a}{s-yellow:i}{s-green:n}{s-blue:b}{s-purple:o}{s-pink:w}").unwrap(),
        Text3dStyling {
            size: 64.,
            stroke: NonZero::new(10),
            color: Srgba::new(0., 1., 1., 1.),
        ...
        Mesh2d::default(),
        MeshMaterial2d(mat.clone()),
        Transform::from_translation(Vec3::new(50., -200., 0.)),
    ));
